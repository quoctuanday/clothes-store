            ...
            <div className="container mx-auto px-6">
                ...
                >
                    <h1 className="text-6xl font-extrabold text-gray-900 mb-6">
                        Giới Thiệu <span className="text-blue-600">CLOTHES-STORE</span>
                    </h1>
                    <p className="text-2xl text-gray-700 max-w-3xl mx-auto">
                        Thương hiệu thời trang CLOTHES-STORE được thành lập từ tháng 3 năm 2018, là thương hiệu thời trang uy tín hàng đầu tại Việt Nam.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20">
                    ...
                    >
                        <img
                            src="https://360.com.vn/wp-content/uploads/2023/11/set-do-3.jpg" // Thay bằng link ảnh từ Google
                            alt="Tầm nhìn"
                            width={500}
                            height={300}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20">
                    ...
                    >
                        <img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThH08VtfATeFNlohYOPOnj5NzGsQ9JDjNvyA&s" // Thay bằng link ảnh từ Google
                            alt="Giá trị cốt lõi"
                            width={500}
                            height={300}
                            className="rounded-lg shadow-2xl transition-transform transform hover:scale-105"
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <h2 className="text-5xl font-semibold text-gray-900 mb-6">Giá trị cốt lõi</h2>
                        <p className="text-xl text-gray-700 mb-6">
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.8 }}
                >
                    <h2 className="text-5xl font-semibold text-gray-900 mb-6">Đội ngũ của chúng tôi</h2>
                    ...
                    {[
                        {
                            ...
                            facebook: 'https://www.facebook.com/profile.php?id=100014294951293',
                            facebookAvatar: 'https://scontent.fhan5-6.fna.fbcdn.net/v/t39.30808-1/438302239_1805358169950664_3144416503454254636_n.jpg?stp=c0.99.200.200a_dst-jpg_p200x200&_nc_cat=105&ccb=1-7&_nc_sid=5f2048&_nc_ohc=34cuBYz0t6gQ7kNvgElpWCe&_nc_ht=scontent.fhan5-6.fna&oh=00_AYBMxMMYOmw3RdP0KdyxGrcaohbB-KGB3VftnSmAzEx0Bg&oe=664F9F4A',
                        },
                        {
                            name: 'Ngô Quang Anh',
                            facebook: 'https://www.facebook.com/qanh5102',
                            facebookAvatar: 'https://scontent.fhan5-11.fna.fbcdn.net/v/t39.30808-1/436118413_1147924739676590_1227838794397871582_n.jpg?stp=cp6_dst-jpg_s200x200&_nc_cat=100&ccb=1-7&_nc_sid=5f2048&_nc_ohc=ZIDfLVqhRm8Q7kNvgHTuRCV&_nc_ht=scontent.fhan5-11.fna&oh=00_AYC7XSoyAd0l2KivAbiSmzlTUAGvnb6zysjke5tDgT1Wag&oe=664FB979',
                        },
                        {
                            name: 'Lý Nhật Long',
                        ...
                        },
                        {
                            ...
                            facebook: 'https://www.facebook.com/profile.php?id=100020561310168',
                        ...
                        },
                        {
                            ...
                            facebookAvatar: 'https://scontent.fhan5-6.fna.fbcdn.net/v/t39.30808-1/245465901_614112776441886_109765014928679402_n.jpg?stp=dst-jpg_p200x200&_nc_cat=107&ccb=1-7&_nc_sid=5f2048&_nc_ohc=r67JQTUL0aoQ7kNvgHf2_ln&_nc_ht=scontent.fhan5-6.fna&oh=00_AYDjPGO5RNB_lYC3-0gM26HlrC8ypkO8k0ejebZ6bfW19Q&oe=664FC63C',
                        },
                    ].map((member, index) => (
                        <motion.div
                            key={index}
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mt-6">
                                <a href={member.facebook} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                    {member.name}
                                </a>
                            </h3>
                        </motion.div>
                ...
                >
                    <div className="mt-10 text-center">
                        <p className="text-gray-700">Ấn vào nút dưới đây để trở về trang chủ</p>
                        <Link href="/home" legacyBehavior>
                            <a className="text-blue-600 hover:underline">Trang chủ</a>
                        </Link>
                    </div>
                </motion.div>
            </div>
